<svelte:head>
    ...
    <meta name="description" content="Transform your business operations with intelligent AI agents and IoT workflow automation across Customer Support, Sales, Marketing, HR, Financial/Accounting, and Management departments." />
</svelte:head>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="text-center">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-300">Average Efficiency Gain</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">60%</div>
                        <div class="text-sm text-gray-600 dark:text-gray-300">Cost Reduction</div>
                    </div>
                </div>
            </div>
            
            <div class="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-lg">
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300">Continuous workflow execution without human intervention</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300">AI agents that learn and adapt to your business rules</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300">Seamless workflows that span multiple departments</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300">Complete visibility into all automated processes</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold mb-2">Discovery & Analysis</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold mb-2">Design & Planning</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold mb-2">Development & Testing</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold mb-2">Deployment & Support</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-lg">
            ...
            <div class="grid md:grid-cols-3 gap-8 text-center">
                <div>
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-300">Average time saved per employee</div>
                </div>
                <div>
                    <div class="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">$50K/year</div>
                    <div class="text-sm text-gray-600 dark:text-gray-300">Typical cost savings per department</div>
                </div>
                <div>
                    <div class="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">6 months</div>
                    <div class="text-sm text-gray-600 dark:text-gray-300">Average payback period</div>
                </div>
            </div>
