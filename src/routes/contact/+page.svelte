    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                ...
                {#if submitMessage}
                    <div class="mb-6 p-4 rounded-lg {submitMessage.includes('Thank you') ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200'}">
                        {submitMessage}
                    </div>
                {/if}
                ...
                <form on:submit={handleSubmit} class="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="fractional-cto">Fractional CTO & Tech Leadership</option>
                            <option value="data-ai-solutions">Data & AI Solutions</option>
                            <option value="digital-transformation">Digital Transformation & Integration</option>
            ...
            <div class="space-y-8">
                <div>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-8">
                        We're here to help you transform your business with cutting-edge technology solutions. Reach out to us through any of the channels below.
                    </p>
                </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-300">hello@alphabits.com</p>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Monday - Friday, 9 AM - 6 PM EST</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-300">Book a free 30-minute discovery call</p>
                            <a href="#" class="text-blue-600 dark:text-blue-400 hover:underline text-sm">Schedule Now →</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6">
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                <h3 class="text-lg font-semibold mb-2">How quickly can you start a project?</h3>
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                <h3 class="text-lg font-semibold mb-2">Do you work with small businesses or just enterprises?</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                <h3 class="text-lg font-semibold mb-2">What's included in a fractional CTO engagement?</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                <h3 class="text-lg font-semibold mb-2">Do you provide ongoing support after implementation?</h3>
                <p class="text-gray-600 dark:text-gray-300">
