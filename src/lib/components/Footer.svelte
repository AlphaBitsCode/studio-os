		...
		<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
			...
			<div class="col-span-1 md:col-span-2">
				...
				<div class="flex space-x-4">
					<a href="#" class="text-gray-600 hover:text-medium-teal transition-colors">
					...
					<a href="https://www.linkedin.com/company/alpha-bits-consulting/" class="text-gray-600 dark:text-gray-300 hover:text-medium-teal dark:hover:text-cyan-accent transition-colors">
			...
			<div>
				...
				<ul class="space-y-3">
					<li><a href="/" class="text-gray-700 hover:text-medium-teal transition-colors">Home</a></li>
					<li><a href="/services" class="text-gray-700 hover:text-medium-teal transition-colors">Services</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-3">
					<li><a href="/blog" class="text-gray-700 hover:text-medium-teal transition-colors">Blog</a></li>
					<li><a href="#" class="text-gray-700 hover:text-medium-teal transition-colors">Contact Us</a></li>
